...
const translations = {
  fr: {
    ...
    heroDesc:
      "Nous sécurisons vos projets, défendons vos intérêts et valorisons votre patrimoine.",
    ...
    consultationCta1: "Prendre rendez-vous",
    consultation2Title: "Consultation vidéo",
    consultation2Price: "180 € TTC",
    consultationCta2: "Prendre rendez-vous",
    consultation3Title: "Consultation vidéo",
    consultation3Price: "180 € TTC",
    consultationCta3: "Prendre rendez-vous",
    ...
    consultationCta4: "Prendre rendez-vous",
    consultation5Title: "Consultation écrite",
    consultation5Desc: "Étude de votre dossier",
    consultation5Price: "720 € TTC",
    consultationCta5: "Prendre rendez-vous",
...
sharonDesc2: "Au cours de son cursus universitaire elle a effectué des stages en cabinet d’Avocats à Nice et à Paris, ainsi qu’au sein du service juridique d’une entreprise à l'étranger.",
...
immobilierMetaDesc: "Assistance juridique en droit immobilier : acquisitions, promotions, transactions, litiges liés aux baux, commissions d’agence et vices cachés. Défendez vos droits avec OUDAR Avocats.",
immobilierTitle: "Droit Immobilier",
immobilierLead: "Vous souhaitez garantir une sécurité juridique optimale pour votre projet d’acquisition immobilière ou pour vos projets de promotion immobilière.",
immobilierServicesTitle: "Nos expertises en droit immobilier",
immobilierService1Title: "Conditions suspensives non réalisées",
immobilierService1Desc: "Nous vous assistons lorsque votre cocontractant refuse ou néglige de remplir une condition suspensive prévue (prêt, congé du locataire, etc.), afin d’obtenir l’exécution forcée ou la libération du contrat avec dommages-intérêts.",
immobilierService2Title: "Paiement de la commission d’agence immobilière",
immobilierService2Desc: "Nous défendons les intérêts des agents immobiliers, vendeurs ou acquéreurs dans les litiges relatifs au paiement des commissions d’agence.",
immobilierService3Title: "Vices cachés",
immobilierService3Desc: "En cas de vice caché dissimulé par le vendeur, nous vous conseillons et vous représentons pour obtenir une réduction du prix, des dommages-intérêts ou la résolution de la vente.",
immobilierSupportTitle: "Litiges liés aux baux d’habitation",
immobilierSupportText: "Propriétaire ou locataire, nous vous accompagnons dans les différends liés au non-paiement des loyers, à la résiliation du bail ou aux troubles de jouissance, et vous représentons devant le Tribunal compétent.",
constructionMetaTitle: "OUDAR Avocats - Droit de la Construction",
constructionMetaDesc: "Avocat expert en droit de la construction à Paris et Nice. OUDAR Avocats accompagne maîtres d’ouvrage et entreprises pour sécuriser les contrats et gérer les contentieux.",
constructionTitle: "Droit de la Construction",
constructionLead: "Notre Cabinet vous accompagne à chaque étape de vos projets de construction, de la sécurisation des contrats aux conseils et contentieux.",
constructionServicesTitle: "Nos domaines d'intervention",
constructionService1Title: "Sécurisation des Contrats",
constructionService1Desc: "Rédaction et analyse de vos contrats et marchés de travaux (contrat d'entreprise, d'architecte, sous-traitance) afin de sécuriser et de rendre transparentes vos opérations entre les intervenants, et ainsi éviter des contentieux parfois coûteux en temps et en argent.",
constructionService2Title: "Accompagnement à la Réception",
constructionService2Desc: "Assistance lors des opérations de réception de chantier, de la livraison d'un bien en VEFA et de la levée des réserves afin de garantir vos droits.",
constructionService3Title: "Conseils et Contentieux",
constructionService3Desc: "Conseil et défense en cas de retard, abandon de chantier, malfaçons, ainsi que pour la mobilisation des garanties légales (décennale, parfait achèvement, etc.).",
constructionSupportTitle: "Une expertise pour tous les acteurs",
constructionSupportText: "Notre Cabinet assiste et conseille les maîtres d’ouvrage, vendeurs promoteurs, maîtres d'œuvre, entreprises générales et sous-traitants dans la gestion de leurs projets et la résolution de leurs litiges sur tout le territoire national.",
...
mediationSupportText: "Formée à la médiation, au processus collaboratif et au coaching systémique, Svetlana OUDAR vous aide à définir les résultats qui vous satisferont à court et long terme, afin de parvenir à une issue amiable, rapide et confidentielle.",
  ...
  en: {
    ...
    heroDesc:
      "We secure your projects, protect your interests, and enhance the value of your assets.",
...
mediationSupportText: "Trained in mediation, collaborative process, and systemic coaching, Svetlana OUDAR helps you define the results that will satisfy you in the short and long term, in order to achieve an amicable, quick, and confidential outcome.",
  ...
  ru: {
    ...
    heroDesc:
      "Мы обеспечиваем надежность ваших проектов, защищаем ваши интересы и укрепляем ценность вашего имущества.",
    ...
    consultation3Title: "Видеоконсультация",
    consultation3Price: "180 € (вкл. НДС)",
    consultationCta3: "Записаться",
    ...
    consultationCta4: "Записаться",
    consultation5Title: "Переписка",
    consultation5Desc: "Изучение вашего досье",
    consultation5Price: "720 € (вкл. НДС)",
    consultationCta5: "Записаться",
    consultationDuration: "Длительность:",
    // Shared Form
...
sharonDesc2: "В ходе своего университетского обучения она проходила стажировки в адвокатских бюро в Ницце и Париже, а также в юридическом отделе компании за рубежом.",
...
immobilierMetaDesc: "Юридическая помощь в сфере права недвижимости: приобретения, девелоперские проекты, сделки, споры по аренде, агентские комиссии и скрытые дефекты. Защитите свои права с OUDAR Avocats.",
immobilierTitle: "Право недвижимости",
immobilierLead: "Желаете обеспечить максимальную юридическую защиту при приобретении недвижимости или при реализации девелоперских проектов?",
immobilierServicesTitle: "Наша экспертиза в области права недвижимости",
immobilierService1Title: "Невыполнение отлагательных условий",
immobilierService1Desc: "Мы защищаем ваши интересы, если контрагент отказывается или уклоняется от выполнения предусмотренного договором отлагательного условия (получение кредита, уведомление арендатора и т. д.), что позволяет добиться либо принудительного исполнения, либо расторжения договора с возмещением убытков.",
immobilierService2Title: "Оплата агентской комиссии по недвижимости",
immobilierService2Desc: "Мы представляем интересы риэлторов, продавцов и покупателей в спорах, связанных с оплатой агентских комиссий.",
immobilierService3Title: "Скрытые дефекты",
immobilierService3Desc: "В случае скрытых дефектов, умышленно скрытых продавцом, мы консультируем и представляем ваши интересы для получения снижения цены, возмещения убытков или расторжения договора купли-продажи.",
immobilierSupportTitle: "Споры по договорам аренды жилья",
immobilierSupportText: "Будь то арендодатель или арендатор, мы сопровождаем вас в спорах, связанных с неуплатой аренды и коммунальных платежей, расторжением договора вследствие нарушений пользования, а также представляем ваши интересы в компетентном суде.",
constructionMetaTitle: "OUDAR Avocats - Строительное право",
constructionMetaDesc: "Адвокат, эксперт в области строительного права в Париже и Ницце. OUDAR Avocats сопровождает заказчиков и компании при обеспечении юридической надежности контрактов и урегулировании споров.",
constructionTitle: "Строительное право",
constructionLead: "Наша коллегия сопровождает вас на всех этапах строительных проектов — от обеспечения надежности договоров до консультаций и разрешения споров.",
constructionServicesTitle: "Наши направления деятельности",
constructionService1Title: "Обеспечение надежности договоров",
constructionService1Desc: "Подготовка и анализ ваших договоров и строительных контрактов (подряд, архитектурные договоры, субподряд) для обеспечения юридической надежности и прозрачности операций между участниками, с целью предотвращения споров, которые могут быть затратными по времени и финансам.",
constructionService2Title: "Сопровождение при сдаче объекта",
constructionService2Desc: "Помощь при приемке строительных работ, передаче недвижимости по договору VEFA и устранении замечаний для защиты ваших прав.",
constructionService3Title: "Консультации и споры",
constructionService3Desc: "Консультирование и защита в случаях задержек, отказа от выполнения работ, строительных дефектов, а также при реализации законных гарантий (десятилетняя ответственность, гарантия полного завершения и др.).",
constructionSupportTitle: "Экспертиза для всех участников",
constructionSupportText: "Наша коллегия консультирует и представляет интересы заказчиков, застройщиков, архитекторов, генеральных подрядчиков и субподрядчиков в управлении проектами и разрешении споров по всей территории страны.",
